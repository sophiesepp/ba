...
public class NgramComposerQuery extends TextResults implements EntryPoint{
	...
	public void onModuleLoad() {	
		...
		leftngramcomposerPanel.addStyleName("leftngramcomoserPanel");
		rightngramcomposerPanel.addStyleName("rightngramcomoserPanel");
		...
		ngramcomposerPanel.add(RootPanel.get("heading15"));
