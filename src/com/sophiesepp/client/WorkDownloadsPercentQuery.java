...
public class WorkDownloadsPercentQuery extends D3 implements EntryPoint{
	


	static VerticalPanel workdownloadsPanel = new VerticalPanel();
	static HorizontalPanel workdownloadscontentPanel = new HorizontalPanel();
	VerticalPanel leftworkdownloadsPanel = new VerticalPanel();
	VerticalPanel rightworkdownloadsPanel = new VerticalPanel();
	...
	public void onModuleLoad() {
		...
		workdownloadscontentPanel.addStyleName("workdownloadscontentPanel");
		leftworkdownloadsPanel.addStyleName("leftworkdownloadsPanel");
		rightworkdownloadsPanel.addStyleName("rightworkdownloadsPanel");
		workdownloadsPanel1.addStyleName("workdownloadsPanel1");
		


		workdownloadsPanel.add(RootPanel.get("heading10"));
		workdownloadsPanel.add(workdownloadscontentPanel);
		
		workdownloadscontentPanel.add(leftworkdownloadsPanel);
		workdownloadscontentPanel.add(rightworkdownloadsPanel);
		
		leftworkdownloadsPanel.add(workdownloadsPanel1);
			
		workdownloadsPanel1.add(RootPanel.get("pieWorkDownloads"));
		

		scrollPanel.setSize("280px","500px");
		rightworkdownloadsPanel.add(scrollPanel);
		scrollPanel.add(RootPanel.get("rightworkdownloadsPanel"));
	}
