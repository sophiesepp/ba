...
public class AgePublicationsComposerQuery extends D3 implements EntryPoint{
	...
	public void onModuleLoad() {
		...
		agepublicationscomposerPanel2.addStyleName("agepublicationscomposerPanel2");
		...
		agepublicationscomposerPanel.add(RootPanel.get("heading17"));
		agepublicationscomposerPanel.add(agepublicationscomposerPanel1);
		agepublicationscomposerPanel.add(agepublicationscomposerPanel2);
