...
public class Srsr implements EntryPoint {
	...
	final Label composerLabel = new Label("Select composer");
	...
	public void onModuleLoad() {
		...
		RootPanel.get("composingContainer").add(RootPanel.get("descriptionComposingContainer"));
		...
		RootPanel.get("useofKeysContainer").add(RootPanel.get("textKeyPercent"));
		RootPanel.get("useofKeysContainer").add(KeyPercentQuery.keypercentPanel);
		RootPanel.get("useofKeysContainer").add(CountryKeyQuery.countrykeyPanel);
		...
		RootPanel.get("percentagesandnumbersContainer").add(WorkScorePercentQuery.workscorePanel);
		RootPanel.get("percentagesandnumbersContainer").add(WorkDownloadsPercentQuery.workdownloadsPanel);
		...
		RootPanel.get("questionsaboutcomposersContainer").add(ComposerGenrePercentQuery.composergenrePanel);
		RootPanel.get("questionsaboutcomposersContainer").add(ComposerKeyPercentQuery.composerkeyPanel);
