...
public class ComposerKeyPercentQuery extends D3 implements EntryPoint{


	static VerticalPanel composerkeyPanel = new VerticalPanel();
	VerticalPanel  composerkeyPanel1 = new VerticalPanel();

	public void onModuleLoad() {

		composerkeyPanel.addStyleName("composerkeyPanel");
		composerkeyPanel1.addStyleName("composerkeyPanel1");
	
		

		composerkeyPanel.add(RootPanel.get("heading19"));
		composerkeyPanel1.add(RootPanel.get("pieComposerKey"));
