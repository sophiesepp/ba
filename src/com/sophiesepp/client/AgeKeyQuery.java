...
public class AgeKeyQuery  extends Heatmap implements EntryPoint{
	...
	public void onModuleLoad() {
		...
		agekeyPanel1.addStyleName("agekeyPanel1");
		agekeyPanel2.addStyleName("agekeyPanel2");
		...
		agekeyPanel.add(RootPanel.get("heading7"));
		...
		greetingService.showQueryAgeKey(buildQueryAgeKey(),new AsyncCallback<List<AgeKey>>() {
			...
			public void onSuccess(List<AgeKey> result){
				...
				{			
					...
					HeatmapObject obj = new HeatmapObject((s.age*3)+40,yValue,s.counts/s.totalpublications);	
					object.add(obj);
