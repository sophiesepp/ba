...
public class TimeKeyQuery extends Heatmap implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		timekeyPanel1.addStyleName("timekeyPanel1");
		timekeyPanel2.addStyleName("timekeyPanel2");
		...
		timekeyPanel.add(RootPanel.get("heading6"));
		...
		greetingService.showQueryTimeKey(buildQueryTimeKey(),new AsyncCallback<List<TimeKey>>() {
			...
			public void onSuccess(List<TimeKey> result) {
				...
				{			
					...
					HeatmapObject obj = new HeatmapObject(s.publication-1700+40,yValue,s.counts/s.totalpublications);	
					object.add(obj);
