...
public class TimeCountryQuery extends Heatmap implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		timecountryPanel1.addStyleName("timecountryPanel1");
		timecountryPanel2.addStyleName("timecountryPanel2");
		...
		timecountryPanel.add(RootPanel.get("heading2"));
		...
		greetingService.showQueryTimeCountry(buildQueryTimeCountry(),
			...
			public void onSuccess(List<TimeCountry> result) {
				...
				{			
					...
					HeatmapObject obj = new HeatmapObject(s.publication-1700+120,yValue,s.counts/s.totalpublications);	
					object.add(obj);
